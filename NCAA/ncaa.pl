#!/c/Users/kevin/Apps/Perl64/bin/perl.exe -w
# !/usr/bin/perl
...
print("\n");
@key_list = ( key1, key2 );
# Why do I do this in a nested loop when it only prints out one line?
foreach $K1 (@key_list) {
  foreach $K2 (@key_list) {
    if ( $K1 lt $K2 ) {
...
print("Note that the tournament was canceled in 2020 due to the pandemic.\n");
