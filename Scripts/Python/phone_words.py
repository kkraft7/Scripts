...
#
# NOT SURE HOW TO MAKE THIS WORK IN WINDOWS/MSYS.
# TRY BUILDING BINARY?! SEE:
# http://aspell.sourceforge.net/man-html/WIN32-Notes.html#WIN32-Notes
#
# NOTES:
...
# (04) The following input arguments give 6 results each:
#      ./phone_words.py 7 8 6
#      ./phone_words.py 7 2 9
#      ./phone_words.py 7 2 4 3
...
# DOESN'T WORK ON WINDOWS! (ASPELL DOESN'T EXIST)
def checkWord(word):
