...
*
* Usage: java Combine2 infile outfile [-gt] [-s Integer]
...
public class Combine2 {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 2) {
            System.out.println("Usage: java Combine2 infile outfile [-gt] [-s SIZE]");
		...
		} else { /* all valid command line arguments and options have been parsed */
		    System.out.println("java Combine2: unrecognized option: " + args[argNo]);
		    System.exit(1);			
                }
            }
        }
